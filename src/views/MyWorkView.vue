      ...
      <div class="col-12 col-md-8 col-lg-9">
        ...
        <h4 class="mb-1">
          <a
            ...
            data-bs-target="#kosikProjectExamples"
            aria-expanded="false"
            aria-controls="kosikProjectExamples"
          >
            Project examples
          </a>
        </h4>
      ...
      <div class="col-12 col-md-8 col-lg-9">
        ...
        <h4 class="mb-1">
          <a
            ...
            type="button"
            data-bs-toggle="collapse"
            data-bs-target="#usetrenoProjectExamples"
            aria-expanded="false"
            aria-controls="usetrenoProjectExamples"
          >
            Project examples
          </a>
        </h4>
        <section
          id="usetrenoProjectExamples"
          class="collapse"
        >
...
article {
  ...
  > *:last-child {
    margin-bottom: 0; // no margin bottom on last element
  }
  ...
  &:not(:first-of-type):before {
    ...
    height: 1px;
    width: 100%;
    background: transparent linear-gradient(90deg, rgba(0, 0, 0, 0) 0%, $sw-blue 50%, rgba(0, 0, 0, 0) 100%);
  }
}
</style>